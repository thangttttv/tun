...
class CreateKeywordsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('keywords', function (Blueprint $table) {
            ...
            $table->string('keyword_only', 4000)->nullable();
            $table->tinyInteger('keyword_only_status')->default(1);
            $table->string('keyword_in', 4000)->nullable();
            $table->tinyInteger('keyword_in_status')->default(1);
            $table->string('keyword_a_and_b', 4000)->nullable();
            $table->tinyInteger('keyword_a_and_b_status')->default(1);
            $table->string('keyword_a_not_b', 4000)->nullable();
